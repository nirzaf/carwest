...
namespace pos
{
    public partial class commies : Form
    {
        public commies(Form form, String user, string invoiceType, string invoino)
        {
            InitializeComponent();
            home = form;
            this.user = user;
        ...
        private void unitPrice_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyValue == 12 || e.KeyValue == 13)
            {
                try
                {
                    ...
                    if (aa == 0)
                    {
                        qtyOut.Text = code.Text;
                    }
                    else
                    {
                        qtyOut.Text = (Double.Parse(code.Text) / 100) * aa + "";
                    }
