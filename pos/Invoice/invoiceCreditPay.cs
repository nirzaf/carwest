...
namespace pos
{
    public partial class invoiceCreditPay : Form
    {
        ...
        void loadInvoice(string id)
        {
            ...
            {
                conn.Open();
                reader = new SqlCommand("select company,auto from customer where id='" + "C-" + id + "'", conn).ExecuteReader();
                if (reader.Read())
                {
        ...
        public void savesub2(double amountD, string tempInvoiceNOS)
        {
            ...
            conn.Open();
            new SqlCommand("insert into chequeInvoiceRetail2 values ('" + tempcreditPaidID + "','" + "C-" + invoiceNO.Text + "','" + chequeAmount.Text + "','" + 0 + "','" + chequeAmount.Text + "','" + chequeNo.Text + "','" + dateTimePicker3.Value + "','" + dateTimePicker1.Value + "','" + "" + "','" + true + "')", conn).ExecuteNonQuery();
            conn.Close();

            conn.Open();
            new SqlCommand("insert into chequeSummery values('" + tempcreditPaidID + "','" + "" + "','" + "" + "','" + true + "','" + false + "','" + false + "','" + chequeAmount.Text + "','" + comboBank.SelectedItem.ToString().Split('-')[0] + "','" + chequeNo.Text + "','" + dateTimePicker3.Value + "','" + false + "','" + true + "','" + "C-" + invoiceNO.Text + "','" + "C-" + invoiceNO.Text + "','" + "" + "','" + "" + "','" + "" + "')", conn).ExecuteNonQuery();
            ...
            conn.Close();
            conn.Open();
            new SqlCommand("insert into cashSummery values('" + "Invoice Credit Paid Cheque-" + tempcreditPaidID + "','" + "CUSTOMER -" + cusLabel.Text + "','" + chequeAmount.Text + "','" + dateTimePicker1.Value + "','" + userH + "')", conn).ExecuteNonQuery();
            conn.Close();
            ...
            try
            {
                ...
                conn.Open();
                new SqlCommand("insert into customerStatement values('" + "SETTELE-" + tempcreditPaidID + "','" + "Settelemnt for Invoice -Cheque" + tempInvoiceNOS + "','" + 0 + "','" + amountD + "','" + true + "','" + dateTimePicker1.Value + "','" + "C-" + invoiceNO.Text + "')", conn).ExecuteNonQuery();
                conn.Close();
        ...
        void saveInvoice()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        new SqlCommand("insert into receipt values('" + recepitNo.Text + "','" + dateTimePicker1.Value + "','" + "" + "','" + "C-" + invoiceNO.Text + "','" + new amountByName().setAmountName(amountD + "") + "','" + amountD + "','" + "" + "','" + cutomerID2 + "','" + "CASH" + "','" + userH + "','" + DateTime.Now + "')", conn).ExecuteNonQuery();

                    }
                    else
                    {

                        new SqlCommand("insert into receipt values('" + recepitNo.Text + "','" + dateTimePicker1.Value + "','" + "" + "','" + "C-" + invoiceNO.Text + "','" + new amountByName().setAmountName(amountD + "") + "','" + amountD + "','" + "" + "','" + cutomerID2 + "','" + "CARD" + "','" + userH + "','" + DateTime.Now + "')", conn).ExecuteNonQuery();
                    ...
                    if (checkBox2.Checked)
                    {
                        ...
                        while (reader2.Read())
                        {
                            ...
                            if (amountTemp2 != 0)
                            {
                                ...
                                conn.Open();
                                reader = new SqlCommand("select amount from returnGoods where invoiceid='" + reader2[0] + "'", conn).ExecuteReader();
                                while (reader.Read())
                                {
                                    //  states = true;
                                    amountTemp = amountTemp - reader.GetDouble(0);
                                    ...
                                    if (dataGridView4.Rows[i].Cells[7].Value.ToString().ToUpper().Equals("TRUE"))
                                    {
                                        ...
                                        if (amount2 != 0)
                                        {
                                            ...
                                            if (amount != 0)
                                            {
                                                ...
                                                {
                                                    conn.Open();
                                                    new SqlCommand("insert into invoiceCreditPaid values('" + dataGridView4.Rows[i].Cells[1].Value.ToString().Split('-')[1] + "','" + dataGridView4.Rows[i].Cells[4].Value + "','" + amount2 + "','" + 0 + "','" + userH + "','" + dateTimePicker1.Value + "','" + dateTimePicker1.Value + "','" + tempcreditPaidID + "')", conn).ExecuteNonQuery();
                                                    //     new SqlCommand("insert into invoiceCreditPaid values('" + reader2[0] + "','" + reader2[2] + "','" + amountTemp2 + "','" + 0 + "','" + userH + "','" + dateTimePicker1.Value + "','" + dateTimePicker1.Value + "','" + tempcreditPaidID + "')", conn).ExecuteNonQuery();
                                                    ...
                                                    if (tempInvoiceNO.Equals(""))
                                                    {
                                                        tempInvoiceNO = "R-" + dataGridView4.Rows[i].Cells[1].Value.ToString().Split('-')[1];
                                                    }
                                                    else
                                                    {
                                                        tempInvoiceNO = tempInvoiceNO + "/R-" + dataGridView4.Rows[i].Cells[1].Value.ToString().Split('-')[1];
                                                    }
                                                    amount2 = 0;
                                                }
                                                else
                                                {
                                                    //  MessageBox.Show("2" + tempInvoiceNO);
                                                    conn.Open();
                                                    new SqlCommand("insert into invoiceCreditPaid values('" + dataGridView4.Rows[i].Cells[1].Value.ToString().Split('-')[1] + "','" + dataGridView4.Rows[i].Cells[4].Value + "','" + amount + "','" + 0 + "','" + userH + "','" + dateTimePicker1.Value + "','" + dateTimePicker1.Value + "','" + tempcreditPaidID + "')", conn).ExecuteNonQuery();
                                                    conn.Close();
...
MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes))
        ...
        void saveInvoice2()
        {
            try
            {
                ...
                else
                {
                    ...
                    conn.Open();
                    //MessageBox.Show(amountD+"");
                    new SqlCommand("insert into receipt values('" + recepitNo.Text + "','" + dateTimePicker1.Value + "','" + "" + "','" + "C-" + invoiceNO.Text + "','" + new amountByName().setAmountName(amountD + "") + "','" + amountD + "','" + "" + "','" + cutomerID2 + "','" + "CHEQUE" + "','" + userH + "','" + DateTime.Now + "')", conn).ExecuteNonQuery();
                    conn.Close();
        ...
        public void saveSub(double amountD, string tempInvoiceNOS)
        {
            try
            {
                try
                {
                    ...
                    conn.Open();
                    new SqlCommand("update receipt set reason='" + "SETTELMENT OF " + tempInvoiceNOS + "' where id='" + tempcreditPaidID + "'", conn).ExecuteNonQuery();
                    conn.Close();
                    conn.Open();
                    if (radioCash.Checked)
                    {
                        new SqlCommand("insert into cashSummery values('" + "Invoice Credit Paid-" + tempcreditPaidID + "','" + "CUSTOMER -" + cusLabel.Text + "','" + amountD + "','" + dateTimePicker1.Value + "','" + userH + "')", conn).ExecuteNonQuery();

                    }
                    else
                    {
                        new SqlCommand("insert into cashSummery values('" + "Invoice Credit Paid Card-" + tempcreditPaidID + "','" + "CUSTOMER -" + cusLabel.Text + "','" + amountD + "','" + dateTimePicker1.Value + "','" + userH + "')", conn).ExecuteNonQuery();
        ...
        double amount3, amount4, retrunAmount;
        void load()
        {
            try
            {
                ...
                try
                {
                    ...
                    // MessageBox.Show(customer);
                    arrayList = new ArrayList();
                    reader2 = new SqlCommand("select sum(amount2) from receipt where customer='" + "C-" + invoiceNO.Text + "' and date<'" + DateTime.Now.Year + "-" + DateTime.Now.Month + "-1" + "" + "' ", conn2).ExecuteReader();
                    if (reader2.Read())
                    {
                ...
                // for (int i = 1; i <= Int32.Parse(db.getLastDate(DateTime.Now.Month, DateTime.Now.Year)); i++)
                {
                    ...
                    // MessageBox.Show(customer);
                    arrayList = new ArrayList();
                    reader2 = new SqlCommand("select a.* from creditInvoiceRetail as a,invoiceTerm as b where a.customerid='" + "C-" + invoiceNO.Text + "' and a.invoiceID=b.invoiceid and b.cheque='" + false + "' and b.card='" + false + "' and B.credit='" + true + "' order by a.date ", conn2).ExecuteReader();
                    while (reader2.Read())
                    {
                        retrunAmount = 0;
                        try
                        ...
                        {
                            conn3.Open();
                            reader3 = new SqlCommand("select paid,balance from INVOICECreditPaid where invoiceID='" + reader2[0] + "'", conn3).ExecuteReader();
                            while (reader3.Read())
                            {
                        ...
                        dataGridView4.Rows.Add(reader2.GetDateTime(6).ToShortDateString(), "R-" + reader2[0], db.setAmountFormat(reader2[2] + ""), "CREDIT INVOICE", (reader2.GetDouble(4) - retrunAmount + ""), amountPaid, db.setAmountFormat(totalOut + ""), false, "0", "OPEN");
                    }
                    conn2.Close();
                    ...
                    //// MessageBox.Show(customer);
                    //arrayList = new ArrayList();
                    //reader2 = new SqlCommand("select * from receipt where customer='" + "C-" + invoiceNO.Text + "' and date='" + DateTime.Now.Year + "-" + DateTime.Now.Month + "-" + i + "" + "' ", conn2).ExecuteReader();
                    //while (reader2.Read())
                    //{
        ...
        private void invoiceNO_KeyUp(object sender, KeyEventArgs e)
        {
            if (!(e.KeyValue == 12 | e.KeyValue == 13 | invoiceNO.Text.Equals("")))
            {
                ...
                try
                {
                    ...
                    conn.Open();
                    reader = new SqlCommand("select ID,company from customer where description like '%" + invoiceNO.Text + "%' ", conn).ExecuteReader();
                    arrayList = new ArrayList();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (!cash.Equals("") && Double.Parse(cash.Text) != 0)
            {
                ...
                conn.Open();
                //MessageBox.Show(amountD+"");
                new SqlCommand("insert into receipt values('" + dateTimePicker1.Value + "','" + "" + "','" + "C-" + invoiceNO.Text + "','" + new amountByName().setAmountName(cash.Text + "") + "','" + cash.Text + "','" + "Cash return on CRedit Settele ISsue" + "','" + "" + "','" + "CASH" + "','" + userH + "','" + DateTime.Now + "')", conn).ExecuteNonQuery();
                conn.Close();
        ...
        private void invoiceNoT_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 12 | e.KeyValue == 13)
            {
                try
                {
                    for (int i = 0; i < dataGridView4.Rows.Count; i++)
                    {
                        if (dataGridView4.Rows[i].Cells[0].Value.ToString().Split('-')[1].ToString().Equals(invoiceNoT.Text))
                        {
        ...
        {
            new customerOutstanding3(this, userH).Visible = true;
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                statmentH.loadBank(DateTime.Now, "C-" + invoiceNO.Text);
                statmentH.Text = "STATEMENT OF " + "C-" + invoiceNO.Text + " ABOVE " + DateTime.Now.Year + "/" + db.getMOnthName(DateTime.Now.Month.ToString()).ToUpper();
        ...
        {
            customerStatement aa = new customerStatement(this, "C-" + invoiceNO.Text, false);
            aa.Visible = true;
            aa.loadBank(DateTime.Now, "C-" + invoiceNO.Text);
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 7)
            {
                try
                {
                    ...
                    {
                        new invoiceNewView(this, userH, dataGridView4.Rows[e.RowIndex].Cells[1].Value.ToString().Split('-')[1]).Visible = true;

                    }
                    else
                    {
                        conn.Close();
                        new invoicePrint().setprintHalfInvoiceServiceRE(dataGridView4.Rows[e.RowIndex].Cells[1].Value.ToString(), "C-" + invoiceNO.Text, "CASH", dataGridView4, 0 + "", cash.Text, 0 + "", DateTime.Now, conn, reader, userH, "", "", "", "");
                        conn.Close();
                    }
                }
                catch (Exception)
        ...
        {
            //customerStatement aa = new customerStatement(this, "C-" + invoiceNO.Text, true);
            //aa.Visible = true;
            //aa.loadBank(DateTime.Now, "C-" + invoiceNO.Text);
            saveInvoice2();
        }
