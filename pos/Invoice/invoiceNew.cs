...
namespace pos
{
    ...
    MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes))
        ...
        double amountCost, temp030, temp3060, temp6090, temp90up, a;

        bool checkload = false, checkPay = false, isCompany = false;
        //   my Method End+++++++++
        double amountPaid, balance_;
