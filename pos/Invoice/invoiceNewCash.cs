...
namespace pos
{
    public partial class invoiceNewCash : Form
    {
        public invoiceNewCash(Form form, String user)
        {
            InitializeComponent();
            home = form;
            this.user = user;
       ...
       MessageBoxDefaultButton.Button1);
                        ...
                        {
                            newItemInvoiceCash ab = new newItemInvoiceCash(this);
    ...
    MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes))
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                new itemTableCash(this, dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString(), dataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString(), dataGridView1.Rows[e.RowIndex].Cells[5].Value.ToString(), e.RowIndex + "", dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString()).Visible = true;
            }
        }
...
MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes))
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    uom = reader[4] + "";
                    //new separate1(this, unitPrice.Text, code.Text, reader[1] + "", reader[4] + "").Visible = true;
                }
                else
                {
