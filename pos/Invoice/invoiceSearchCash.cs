...
namespace pos
{
    public partial class invoiceSearchCash : Form
    {
        public invoiceSearchCash(Form form, String user)
        {
            InitializeComponent();
            this.user = user;
            home = form;
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (reader2.Read())
                    {
                        ...
                        {
                            // MessageBox.Show("1");
                            dataGridView1.Rows.Add(reader.GetDateTime(3).ToShortDateString(), vehicleNO + "", "R-" + reader[0], db.setAmountFormat(reader[2] + ""), 0, db.setAmountFormat(reader[2] + ""));
