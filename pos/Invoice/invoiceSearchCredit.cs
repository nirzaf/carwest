...
namespace pos
{
    public partial class invoiceSearchCredit : Form
    {
        public invoiceSearchCredit(Form form, String user)
        {
            InitializeComponent();
            this.user = user;
            home = form;
                ...
                while (reader.Read())
                {
                    ...
                    if (reader2.Read())
                    {
                        ...
                        if (reader2.GetBoolean(2))
                        {
                            ...
                            {
                                //MessageBox.Show(reader[0]+"");
                                dataGridView1.Rows.Add(reader.GetDateTime(3).ToShortDateString(), "R-" + reader[0], vehicleNO, db.setAmountFormat(reader2[4] + ""));
