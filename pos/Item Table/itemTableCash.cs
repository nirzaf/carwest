...
namespace pos
{
    public partial class itemTableCash : Form
    {
        private invoiceNewCash formH;
        private DB db;
        private string indexH;

        public itemTableCash(invoiceNewCash form, string unitPriceH, string discountH, string qtyH, string index, string codeH)
        {
            InitializeComponent();
            formH = form;
            indexH = index;
