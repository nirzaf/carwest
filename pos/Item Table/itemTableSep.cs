...
namespace pos
{
    public partial class itemTableSep : Form
    {
        ...
        public itemTableSep(invoiceNew form, string unitPriceH, string discountH, string qtyH, string index, string codeH, string countH)
        {
            InitializeComponent();
            formH = form;
            indexH = index;
