...
namespace pos
{
    ...
    {
        public chequeGrn(Form home, String user)
        {
            InitializeComponent();
            formH = home;
            userH = user;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!radioAdvancedSearch.Checked)
                {
                    ...
                    reader = new SqlCommand("select a.grnID,b.subTotal,a.cheque,a.chequenumber,a.checkCodeNo,a.chequeDate,b.supplierID from chequeGRN as a,grn as b where b.id=a.grnID " + queary, conn).ExecuteReader();
                    ...
                    while (reader.Read())
                    {
                        try
                        {
                            ...
                            conn2.Open();
                            reader2 = new SqlCommand("select id,name,company from supplier where id='" + reader[6] + "'", conn2).ExecuteReader();
                            if (reader2.Read())
                            {
                                // MessageBox.Show("sa");
                                dt.Rows.Add(reader[6], reader2[0].ToString().ToUpper() + " " + reader2[1].ToString().ToUpper() + " " + reader2[2].ToString().ToUpper(), reader[0], reader.GetDouble(1), reader.GetDouble(2), reader[3] + "", reader[4], reader.GetDateTime(5).ToShortDateString());
                            }
                            else
                            {
                                dt.Rows.Add(reader[6], reader[6], reader[0], reader.GetDouble(1), reader.GetDouble(2), reader[3] + "", reader[4], reader.GetDateTime(5).ToShortDateString());
                            }
                            conn2.Close();
                ...
                else
                {
                    for (int i = 0; i < dataGridView2.Rows.Count; i++)
                    {
                        ...
                        reader = new SqlCommand("select a.grnID,b.subTotal,a.cheque,a.chequenumber,a.checkCodeNo,a.chequeDate,b.supplierID from chequeGRN as a,grn as b where b.id=a.grnID and b.supplierID='" + dataGridView2.Rows[i].Cells[0].Value + "'" + queary, conn).ExecuteReader();
        ...
        private void toolStripTextBox1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 12 | e.KeyValue == 13)
            {
                ...
                try
                {
                    ...
                    conn.Open();
                    reader = new SqlCommand("select a.grnID,b.subTotal,a.cheque,a.chequenumber,a.checkCodeNo,a.chequeDate,b.supplierID from chequeGRN as a,grn as b where b.id=a.grnID and a.chequenumber='" + toolStripTextBox1.Text + "'" + queary, conn).ExecuteReader();
