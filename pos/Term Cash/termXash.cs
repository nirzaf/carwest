...
namespace pos
{
    public partial class termXash : Form
    {
        public termXash(invoiceNew invoice, Double Amount, Double cashPaidH, String[] creditDetail, String[] chequeDetail, String[] cardDetail, bool creditH, bool chequeH, bool cardH)
        {
            InitializeComponent();
            sub = Amount;
        ...
        private invoiceNew invoiceHome;
