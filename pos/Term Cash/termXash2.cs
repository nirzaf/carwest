...
namespace pos
{
    public partial class termXash2 : Form
    {
        public termXash2(invoiceEdit invoice, Double Amount, Double cashPaidH, String[] creditDetail, String[] chequeDetail, String[] cardDetail, bool creditH, bool chequeH, bool cardH)
        {
            InitializeComponent();
            sub = Amount;
        ...
        private invoiceEdit invoiceHome;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    invoiceHome.cashPaid.Text = cashPaid.Text;
                    invoiceHome.balance.Text = balance.Text;
                    invoiceHome.paidAmount = credit + cheque + card;
                    this.Dispose();
                    invoiceHome.Enabled = true;
                    invoiceHome.setTermBack(true);
                    invoiceHome.TopMost = true;
