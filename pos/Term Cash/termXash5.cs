...
namespace pos
{
    public partial class termXash5 : Form
    {
        public termXash5(purchasing invoice, Double Amount, Double cashPaidH, String[] creditDetail, String[] chequeDetail, String[] cardDetail, bool creditH, bool chequeH, bool cardH)
        {
            InitializeComponent();
            sub = Amount;
        ...
        private purchasing invoiceHome;
