...
namespace pos
{
    public partial class termXash6 : Form
    {
        public termXash6(returnGRN invoice, Double Amount, Double cashPaidH, String[] creditDetail, String[] chequeDetail, String[] cardDetail, bool creditH, bool chequeH, bool cardH)
        {
            InitializeComponent();
            sub = Amount;
