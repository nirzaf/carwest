...
namespace pos
{
    public partial class termXash7 : Form
    {
        public termXash7(invoicePay invoice, Double Amount, Double cashPaidH, String[] creditDetail, String[] chequeDetail, String[] cardDetail, bool creditH, bool chequeH, bool cardH)
        {
            InitializeComponent();
            sub = Amount;
        ...
        private invoicePay invoiceHome;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    invoiceHome.cash.Text = cashPaid.Text;
