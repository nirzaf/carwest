...
namespace pos
{
    public partial class cusBalance : Form
    {
        public cusBalance(Form form, String user, string invoiceType, string invoino)
        {
            InitializeComponent();
            home = form;
            this.user = user;
                ...
                try
                {
                    ...
                    for (int i = 0; i < dataGridView1.Rows.Count; i++)
                    {
                        ...
                        if (dataGridView1.Rows[i].Cells[9].Value.ToString().ToUpper().Equals("TRUE"))
                        {
                            ...
                            conn.Close();
                            conn2.Open();
                            new SqlCommand("insert into returnGoods values ('" + dataGridView1.Rows[i].Cells[1].Value + "','" + Double.Parse(dataGridView1.Rows[i].Cells[6].Value.ToString()) + "','" + cutomerID + "','" + false + "','" + Double.Parse(dataGridView1.Rows[i].Cells[8].Value.ToString()) + "','" + DateTime.Now + "')", conn2).ExecuteNonQuery();
                            conn2.Close();
                        }
                        else
                        {
                            ...
                            conn.Close();
                            conn2.Open();
                            new SqlCommand("insert into returnGoods values ('" + dataGridView1.Rows[i].Cells[1].Value + "','" + Double.Parse(dataGridView1.Rows[i].Cells[6].Value.ToString()) + "','" + cutomerID + "','" + true + "','" + Double.Parse(dataGridView1.Rows[i].Cells[8].Value.ToString()) + "','" + DateTime.Now + "')", conn2).ExecuteNonQuery();
                            conn2.Close();
                        }
