...
namespace pos
{
    public partial class invoiceSelection2 : Form
    {
        public invoiceSelection2(string cus, string amo, string use, string tempCreID, termXash9 form)
        {
            InitializeComponent();
            customer = cus;
